    ...
    return (
        <div className='mt-5 lg:mt-1'>
            <h1 className="text-white font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl tracking-tight leading-tight text-center">
                BMF  <span className="text-red-500">Members</span>
            </h1>

            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4  gap-2 mt-10 mb-10 px-0.5 lg:gap-8 lg:mt-10 lg:mb-20 lg:px-4">
                {data.map((member) => (
                    <div
                        key={member.id}
